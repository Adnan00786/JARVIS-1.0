...
text = pyfiglet.print_figlet(text='J A R V I S ',colors='GREEN')
...
#     try:
#         playsound("D:\\Music\\google_now_voice.mp3")
#     except:
#         try:
#             import pyautogui
...
def main_tkinter_gui():
    ...
    screen_main.title("JARVIS (Created By Adnan)")
    screen_main.configure(background="black")
    screen_main.iconbitmap("D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\icon.ico")
    def color_changer():
        colors = ["silver","light green", "red" , "white" , "gold"]
    ...
    def time():
        string1 = strftime('%A,%d %B')
        string2 = strftime('%H hours %M minutes %p')
        # string2 = strftime('%H:%M:%S %p')
        # strftime()
        label.config(text=string1)
        label.after(10000,time)
        label_time.config(text=string2)
        label_time.after(1000,time)
        # minute = strftime('%M')

    label = Label(screen_main,font=('futura bold',25),background="black",border="0",foreground="orange")
    label.place(x=10,y=58)
    label_time = Label(screen_main,font=('futura bold',30),background="black",border="0",foreground="light blue")
    ...
    def day():
        ...
        label_day.after(1000,time)
        minute = strftime('%M')

    label_day = Label(screen_main,font=('futura bold',35),background="black",border="0",foreground="cyan")
    label_day.place(x=10,y=20)
    time()
    ...
    # anim1_main.place(x=1050,y=290)
    anim1_main.place(x=390,y=150)
    # anim1_main = MyLabel(screen_main,"D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\Center main image.gif")
    # anim1_main.configure(width=680,height=430)
    # # anim1_main.place(x=1050,y=290)
    # anim1_main.place(x=390,y=250)
    ...
    def task():
        ...
        def NewsFromBBC():
            ...
            "source": "bbc-news",
            "sortBy": "top",
            "apiKey": "0a83a83e2b3f458c870d59d4bb7fd150"
            }
        ...
        while True:
            ...
            if 'hello'  in query:
                ...
                try:
                    speak("Ok sir")
                    os.startfile(":\\Users\\ALI\\Videos\\yt1s.com - Coke Studio Special  AsmaulHusna  The 99 Names  Atif Aslam.mp4")
                    sleep(195.4)
                except:
                    speak("Extremely sorry sir , could not play 99 names of allah")
                ...
                try:
                    # playsound("C:\\Users\\ALI\\Music\\Baaghi FIGHT song\\Data\\FIGHT project.wav")

                    speak("How you feel sir?")
                except:
                    print('error')
                ...
                try:
                    ...
                    os.startfile("D:\\Music\\Black-Panther-Song-Respect-My-Throne-Karaoke-Lyric-Video-Prod-by-Caliber-Beats-NerdOut_qCvGbBCPbnk.mp3")
                    os.startfile("D:\\Music\\So Long Live The King Official Song Will Definitely Motivate you Global Music.mp3")
                except:
                    speak("Unable to play music")

            elif 'game' in query:
                try:
                    os.startfile("D:\\Music\\Jarvis Start Up.wav")
                except:
                    speak("Unable to prepare Game environment")
                ...
                try:
                    ...
                    if 'fine' in fine_reply_back:
                        ...
                        def detect_sentiment():
                            ...
                            speak("I think You are are feeling ")
                            sentiment_dict = sid_obj.polarity_scores(query)

                            string1 = str(sentiment_dict['neg']*100) , "% Negative"
                            speak(string1)

                            string2 = str(sentiment_dict['neu']*100) , "% Neutral"
                            speak(string2)

                            string3 = str(sentiment_dict['pos']*100) ,"% Positive"
                            speak(string3)
                ...
                try:
                    speak("Ok sir Getting Top News headlines")
                    NewsFromBBC()
                except:
                    speak("sorry sir , I am unable to get News Headlines.")
    ...
    # mywhatsapp = Button(screen_main, text="WHATSAPP WEB", command=whatsappweb,font="LUCIDA 15 bold").pack(padx=20,pady=20)
    ...
    my_news = Button(screen_main,border="0",background="black",foreground="cyan", text="News", command=NewsFromBBC,font="LUCIDA 15 bold")
    ...
    def restrt():
        os.startfile("D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\main.py")
        screen_main.destroy()
        exit()
    button2_ = Button(screen_main,background="black",foreground="Gold", font=('space age',35),text='Restart', command=restrt)
    button2_.place(x=1180,y=700)
    def end_exit():
        screen_main.destroy()
        exit()
    button3_ = Button(screen_main,background="black",foreground="Gold", font=('Austere',25),text='EXIT', command=end_exit)
    button3_.place(x=950,y=700)
    def btn_sleep():
        try:       
            speak("ok sir .")            
            var = IntVar()
    ...
    button4_ = Button(screen_main,background="black",foreground="Gold", font=('Austere',23),text='Sleep', command=btn_sleep)
    button4_.place(x=1060,y=700)
...
def initiating_loading_animated():
    ...
    root.iconbitmap("D:\\3D Objects\\CHANNEL\\HOBBY MASTER\\channel_logo.png")

    # my_label = Label(root)
    # my_label.configure(width=450,height=250)
    # my_label.place(x=90,y=190)
    # player = tkvideo("D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\AI build.mp4", my_label, loop = 1, size = (1280,720))
    # player.play()
    ...
    label = Label(root,font=('futura bold',35),background="black",foreground="cyan")
    label.place(x=10,y=10)
    time()

    Label(root, text= "Initiating JARVIS",borderwidth=5,border=2,
    font=('Austere',40)).pack(pady=10)

    anim1 = MyLabel(root, "D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\initaite.gif")
    anim1.configure(wraplength=300, justify="center")
    anim1.pack( anchor=CENTER,pady=180)

    anim2 = MyLabel(root, "D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\motionGraphics.gif")
    anim2.configure(width=350,height=280)
    anim2.pack(side=BOTTOM,anchor=NW)
    anim2.place(x=60,y=620)

    anim3 = MyLabel(root,"D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\suit.gif" )
    anim3.configure(width=380,height=480)
    anim3.pack(side=RIGHT)
    anim3.place(x=1060,y=190)
    

    root.after(10,speak("Initiating JARVIS"))

    #Automatically close the window after 11.41 seconds
    root.after(11410,lambda:root.destroy())
...
def verify_biometric_scan():
    ...
    second_screen.configure(background="black")
    second_screen.iconbitmap("D:\\3D Objects\\CHANNEL\\HOBBY MASTER\\channel_logo.png")

    Label(second_screen, text= "Please Verify Biometric scan to Initiate system.",borderwidth=5,border=2,
    font=('Austere',40)).pack(pady=20)

    second_anim2 = MyLabel(second_screen,"D:\\3D Objects\\python Projects\\Face-Recognition-main\\Project JARVIS Advanced\\detect_success.gif")
    second_anim2.configure(width=700,height=100990800)
    second_anim2.configure(wraplength=160000, justify="center")
    second_anim2.pack( side=BOTTOM,pady=150)
    ...
    label = Label(second_screen,font=('futura bold',35),background="black",foreground="cyan")
    label.place(x=1200,y=150)
    time()

    def exit_second_screen():
        second_screen.after(1000,lambda:second_screen.destroy())



    btn = Button(second_screen,text="Verify Biometric Scan.",font=("space age",30), 
            command=lambda:[exit_second_screen()]
             ).place(x=800, y=750)
    

    # second_screen.after(11410,lambda:second_screen.destroy())
...
# initiating_loading_animated()
# verify_biometric_scan()
# verified_biometric_scan()
# 
main_tkinter_gui()
